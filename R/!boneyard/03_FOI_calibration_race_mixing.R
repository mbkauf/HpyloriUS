...
W1 <- matrix(c(1, 1, 3, 4, 5, 6, 7, 8, 33, 33, rep(0, 6), 34, 34, rep(0, 6), 35, 35, rep(0, 6)),
             c(0, 2, 3, 4, 5, 6, 7, 8, 33, 33, rep(0, 6), 34, 34, rep(0, 6), 35, 35, rep(0, 6)),
             c(0, 0, 3, 4, 5, 6, 7, 8, rep(0, 24)),
             c(rep(0, 3), 4, 5, 6, 7, 8, rep(0, 24)),
             c(rep(0, 4), 5, 6, 7, 8, rep(0, 24)),
             c(rep(0, 5), 6, 7, 8, rep(0, 24)),
             c(rep(0, 6), 7, 8, rep(0, 24)),
             c(rep(0, 7), 8, rep(0, 24)),
             c(rep(0, 8), 9, 9, 11, 12, 13, 14, 15, 16, 36, 36, rep(0, 6), 37, 37, rep(0, 6)),
             c(rep(0, 9), 10, 11, 12, 13, 14, 15, 16, 36, 36, rep(0, 6), 37, 37, rep(0, 6)),
             c(rep(0, 10), 11, 12, 13, 14, 15, 16, rep(0, 16)),
             c(rep(0, 11), 12, 13, 14, 15, 16, rep(0, 16)),
             c(rep(0, 12), 13, 14, 15, 16, rep(0, 16)),
             c(rep(0, 13), 14, 15, 16, rep(0, 16)),
             c(rep(0, 14), 15, 16, rep(0, 16)),
             c(rep(0, 15), 16, rep(0, 16)),
             c(rep(0, 16), 17, 17, 19, 20, 21, 22, 23, 24, 38, 38, rep(0, 6)),
             c(rep(0, 17), 18, 19, 20, 21, 22, 23, 24, 38, 38, rep(0, 6)),
             c(rep(0, 18), 19, 20, 21, 22, 23, 24, rep(0, 8)),
             c(rep(0, 19), 20, 21, 22, 23, 24, rep(0, 8)),
             c(rep(0, 20), 21, 22, 23, 24, rep(0, 8)),
             c(rep(0, 21), 22, 23, 24, rep(0, 8)),
             c(rep(0, 22), 23, 24, rep(0, 8)),
             c(rep(0, 23), 24, rep(0, 8)),
             c(rep(0, 24), 25, 25, 27, 28, 29, 30, 31, 32),
             c(rep(0, 25), 26, 27, 28, 29, 30, 31, 32),
             c(rep(0, 26), 27, 28, 29, 30, 31, 32),
             c(rep(0, 27), 28, 29, 30, 31, 32),
             c(rep(0, 28), 29, 30, 31, 32),
             c(rep(0, 29), 30, 31, 32),
             c(rep(0, 30), 31, 32),
             c(rep(0, 31), 32), ncol = 32, byrow = T)


beta0 <- c(rep(c(0.8, 0.7, 0.6, 0.5, 0.4, 0.3, 0.2, 0.1), 4), rep(0.5, 6))
